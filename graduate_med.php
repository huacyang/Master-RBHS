    ...
    <div id="submain" class="nine push-three mobile-four columns">
        ...
        <div id="context" class="eight mobile-four columns">
            <h1 id="page-title">Graduate Medical Education</h1>
                <p><a href="http://magazine.rutgers.edu/departments/winter-2013/on-the-banks/rx-for-medicine" target="_blank"><img src="images/LeeAnnRoberts_th.jpg" alt="chancellor" style="float:left;" class="inline-left"/></a>Graduate medical education programs enables RBHS to provide the highest quality medical care to our patients while supporting our mission of educating future generations of physicians to serve with the highest standards of professionalism. Residencies and fellowships are offered in a wide variety of fields.</p>
