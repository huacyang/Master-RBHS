...
<body>
    ...
    <div id="submain" class="nine push-three mobile-four columns">
        ...
        <div class="twelve columns"><br/>
        	<img src="images/research_630_577_bnr.jpg" alt="Glass bottles and three students talking in a lab" title="Glass bottles and three students talking in a lab" />
        </div>
        </div>
        <br/>
        <div class="row">
        <div id="context" class="eight mobile-four columns">
            <h1 id="page-title">Research Overview</h1>
                <p>Rutgers is a leading national research university, with a depth and breadth of research activity and resources unparalleled in New Jersey. With the establishment of Rutgers Biomedical Health Sciences, Rutgers moves to new heights and now stands as one of America&rsquo;s largest, most comprehensive university-based centers for studying and improving human health and health care. Through basic, translational, and clinical research&mdash;spanning the life sciences, physical sciences, and social sciences&mdash;we advance knowledge and technology that drive education, medical breakthroughs, and economic development, while improving lives at home and in the global community.<br/>
<br/>
Led by the university&rsquo;s faculty, research is supported by staff in many units. The <a href="http://vpr.rutgers.edu" target="_blank">Office of the Vice President for Research and Economic Development</a> facilitates grant applications, research alliances, technology commercialization, and relationships among faculty and the business community. </p>
...
<li><a href="http://sph.umdnj.edu/units/unit.detail.cfm?unitID=12" target="_blank">School of Public Health</a> <span class="red">[URL TO CHANGE]</span></li>
          ...
          <h2>Research Centers and Institutes</h2>
                <p><span class="red">Rutgers [or RBHS?]</span> is home to XXX <a href="institutes.php">centers and institutes</a> that work collaboratively across disciplines within Rutgers and with other institutions worldwide. </p>
                 ...
                 <ul><li>Rutgers <a href="http://ora.rutgers.edu" target="_blank">Office of Research Alliances</a> works with Rutgers faculty and staff, major corporations and the region&rsquo;s business community, and allies such as BioNJ and N.J. Business and Industry association, to make connections and foster collaborations for research and development initiatives across all of our campuses.</li>
                 <li>Rutgers <a href="http://cro.umdnj.edu" target="_blank">Clinical Research Organization</a> <span class="red">[URL TO CHANGE]</span> is the gateway to RBHS&rsquo;s statewide clinical trial activities. Dedicated to effective collaboration between industry and academia to advance care and the boundaries of health care treatment, we partner with patients, industry, and practitioners to identify appropriate investigators and academic resources to meet patients&rsquo; needs.</li>
