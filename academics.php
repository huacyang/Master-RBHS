...
<li>A.S., A.A.S., undergraduate certificates.</li></ul>

            <h2>Learning through Clinical Practice</h2>
                <p>In addition to learning in our principal teaching hospitals, a key component of an RBHS education is your opportunity to learn in our own faculty practices, community health centers, clinical practices, and scores of other hospital and clinical affiliates.</p>
          
            <h3>Principal Teaching Hospitals</h3>
                <ul><li>The principal teaching hospital of New Jersey Medical School is <a href="http://www.theuniversityhospital.com" target="_blank">University Hospital</a>, northern New Jersey&rsquo;s only Level 1 Trauma Center and a vital health care resource for Newark and surrounding communities.</li>
<li>The principal teaching hospital of Robert Wood Johnson Medical School is <a href="http://www.rwjuh.edu" target="_blank">Robert Wood Johnson University Hospital</a>, which consistently ranks among the region&rsquo;s top hospitals.</li></ul>

<h3>Faculty and Clinical Practices, Community Health</h3>
               <ul>
                  <li><a href="practices.php">Faculty and Clinical Practices</a></li>
<li><a href="community.php">Community Health</a></li>
<li>Clinical Affiliates <span class="red">[LINK TO NEW AFFILIATION AGREEMENTS PAGE IN CORE SITE HEALTH SCIENCES]</span></li></ul>
        ...
        <ul>
            <!-- Panel One -->
            <li>
            <h2>Dual and Joint Degree Programs</h2>
                <p>The schools of Rutgers Biomedical Health Sciences offer numerous dual and joint degree programs with each other, with other schools within Rutgers, and with schools at other institutions. You will find information about dual and joint degree options when you explore individual school websites. <a href="schools.php">Learn more</a>.</p>
...
With more than two dozen centers and reading rooms across our campuses, the Rutgers University Libraries rank among the nation&rsquo;s top research library systems. <a href="http://www.rutgers.edu/academics/libraries" target="_blank">Learn more</a>.</p>
    ...
    <div class="row">
        ...
        <ul>
            <li><a href="http://www.rutgers.edu/academics/academics-rutgers" target="_blank">Academics Universitywide</a></li>
            <li>Health Sciences Academics Universitywide  <span class="red">[LINK TO NEW HEALTH SCIENCES ACADEMICS PAGE ON CORE SITE]</span></li>
            <li><a href="http://www.rutgers.edu/about-rutgers/national-rankings" target="_blank">National Rankings</a></li>
