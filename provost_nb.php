...
<head>
	...
	<title>Provost for RBHS New Brunswick Programs | Rutgers Biomedical and Health Sciences</title>
...
<body>
    ...
    <div id="submain" class="nine push-three mobile-four columns">
        ...
        <div id="context-large" class="twelve mobile-four columns">
            <h1 id="page-title">Provost for RBHS New Brunswick Programs</h1>
                <p><img src="images/blankperson.jpg" alt="chancellor" style="float:left;" class="inline-left"/>Reporting directly to the chancellor, provost Firstname Lastname is responsible for.... He/She came to Rutgers from... where he/she accomplishments.... [BIO TO COME]</p>
