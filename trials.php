...
<head>
	...
	<title>Clinical Trials | Rutgers Biomedical and Health Sciences</title>
...
<body>
    ...
    <div id="submain" class="nine push-three mobile-four columns">
        ...
        <div class="twelve columns"><br/>
        	<img src="images/patientcare_trials_122_.jpg" alt="Doctor talking to a female patient in a wheelchair" title="Doctor talking to a female patient in a wheelchair" />
        </div>
        </div>
        <br/>
        <div class="row">
        <div id="context" class="eight mobile-four columns">
            <h1 id="page-title">Clinical Trials</h1>
                <p>Clinical trials are scientific research studies designed to find better ways to treat or prevent diseases. RBHS has clinical research at every school and campus, involving hundreds of researchers. The faculty at our two medical schools, our dental school, nursing schools, and other allied health schools are dedicated to moving forward discovery in drugs, biologics, devices, preventive and therapeutic strategies, behavioral research, and other interventions to improve human life. RBHS supports more than 500 clinical trials on any given day of the year. </p>
            <h2>Start Here</h2>
...
As one of only 14 National Cancer Institute-designated Minority-Based Community Clinical Oncology Programs, the <a href="http://njmsuhcc.umdnj.edu/home" target="_blank">New Jersey Medical School Cancer Center</a> <span class="red">[URL TO CHANGE]</span> is uniquely positioned to offer state-of-the-art clinical trials to the patients through numerous active protocols in dozens of NCI-approved clinical trials. <a href="http://njmsuhcc.umdnj.edu/home/index.php/clinical-research-unit.html" target="_blank">Learn more</a>.  <span class="red">[URL TO CHANGE]</span></p>
    ...
    <div class="row">
        ...
        <ul>
            <li><a href="http://cro.umdnj.edu" target="_blank">Rutgers Clinical Research</a> <span class="red">[URL TO CHANGE]</span></li>
            <li><a href="http://cinj.org" target="_blank">Cancer Institute of New Jersey</a></li>
            <li><a href="http://http://njmsuhcc.umdnj.edu/home" target="_blank">New Jersey Medical School Cancer Center</a> <span class="red">[URL TO CHANGE]</span></li>
        </ul>
        </div>
    </div>
	</div>
