...
<head>
	...
	<title>Graduate Education | Rutgers Biomedical and Health Sciences</title>
...
<body>
    ...
    <div id="submain" class="nine push-three mobile-four columns">
        ...
        <div class="twelve columns"><br/>
        	<img src="images/academics_grad_1006_bnr.jpg" alt="Students helping patients in a classroom" title="Students helping patients in a classroom" />
        </div>
        </div>
        <br/>
        <div class="row">
        <div id="context" class="eight mobile-four columns">
          <h1 id="page-title">Graduate Education</h1>
                <p>RBHS offers a wide variety of advanced education programs through its schools. More than 700 doctoral degrees are awarded each year by RBHS  schools, from the M.D. and D.M.D. to the doctor of physical therapy and the  Ph.D. Hundreds more master&rsquo;s level degrees are awarded annually in such diverse fields as biomedical informatics, clinical nutrition, and nursing.</p>
<ul>
            <li><a href="http://nursing.rutgers.edu/prospective_students/academic_programs" target="_blank">College of Nursing</a></li>
                        ...
                        <li><a href="http://njms.umdnj.edu/gsbs" target="_blank">Graduate School of Biomedical Sciences at Newark</a> <span class="red">[URL TO CHANGE]</span></li>
                        <li><a href="http://gsbs.umdnj.edu" target="_blank">Graduate School of Biomedical Sciences at New Brunswick</a> <span class="red">[URL TO CHANGE]</span></li>
                        <li><a href="http://njms.umdnj.edu/index.cfm" target="_blank">New Jersey Medical School</a> <span class="red">[URL TO CHANGE]</span></li>
                        <li><a href="http://rwjms.umdnj.edu/education/index.html" target="_blank">Robert Wood Johnson Medical School</a>  <span class="red">[URL TO CHANGE]</span></li>
                        <li><a href="http://dentalschool.umdnj.edu" target="_blank">Rutgers School of Dental Medicine</a> <span class="red">[URL TO CHANGE]</span></li>
                        <li><a href="http://shrp.umdnj.edu" target="_blank">School of Health Related Professions</a> <span class="red">[URL TO CHANGE]</span></li>
...
<br/>
&ldquo;We provide students with a platform to launch their profession,&rdquo; says Roberts. &ldquo;Whether they&rsquo;re thinking about becoming the best neurosurgeon in the country or going into policy and advocacy as a physician, we provide a training ground.&rdquo;</p>
    ...
    <div class="row">
        ...
        <ul>
            ...
            <li><a href="http://www.rutgers.edu/academics/graduate-education" target="_blank">Universitywide Graduate Education</a></li>
            <li>Universitywide Health Sciences <span class="red">[LINK TO HEALTH SCIENCES EDUCATION ON CORE SITE]</span></li>
